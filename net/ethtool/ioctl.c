...
static int ethtool_get_ringparam(struct net_device *dev, void __user *useraddr)
{
	...
	if (!dev->ethtool_ops->get_ringparam && !dev->ethtool_ops->get_ringparam_new)
		return -EOPNOTSUPP;

	if (dev->ethtool_ops->get_ringparam)
		dev->ethtool_ops->get_ringparam(dev, &ringparam);
	else
		dev->ethtool_ops->get_ringparam_new(dev, &ringparam,
...
static int ethtool_set_ringparam(struct net_device *dev, void __user *useraddr)
{
	...
	if ((!dev->ethtool_ops->set_ringparam || !dev->ethtool_ops->get_ringparam) &&
	    (!dev->ethtool_ops->set_ringparam_new || !dev->ethtool_ops->get_ringparam_new))
		return -EOPNOTSUPP;
	...
	if (dev->ethtool_ops->get_ringparam)
		...
		dev->ethtool_ops->get_ringparam_new(dev, &max, &kernel_ringparam, NULL);
	...
	if (dev->ethtool_ops->set_ringparam)
		...
		ret = dev->ethtool_ops->set_ringparam_new(dev, &ringparam,
						          &kernel_ringparam, NULL);
	if (!ret)
