...
struct rds_net {
	 ...
	 * by the module value (RDS_NL_MOD_*).  When accessing this
	 * array, subtract one from module value (RDS_NL_MOD_*) to get
	 * to the correct position.
	 */
	struct rds_stats_struct	*rns_mod_stats[RDS_MOD_MAX - 1];
};
...
static inline void __percpu *__rds_get_mod_stats(struct rds_net *rns,
						 int module)
{
	return rns->rns_mod_stats[module - 1]->rs_stats;
}
