...
BTF_SET_START(xdp_metadata_kfunc_ids)
#define XDP_METADATA_KFUNC(_, name) BTF_ID_FLAGS(func, name, 0)
XDP_METADATA_KFUNC_xxx
#undef XDP_METADATA_KFUNC
BTF_SET_END(xdp_metadata_kfunc_ids)

static const struct btf_kfunc_id_set xdp_metadata_kfunc_set = {
	.owner = THIS_MODULE,
	.check_set   = &xdp_metadata_kfunc_ids,
};
...
{
	return btf_id_set_contains(&xdp_metadata_kfunc_ids, btf_id);
}
