...
make -j$(nproc) binrpm-pkg
 Wrote: /home/opc/linux-uek/rpmbuild/RPMS/x86_64/kernel-headers-7.1.0+-2.x86_64.rpm
 Wrote: /home/opc/linux-uek/rpmbuild/RPMS/x86_64/kernel-devel-7.1.0+-2.x86_64.rpm
 Wrote: /home/opc/linux-uek/rpmbuild/RPMS/x86_64/kernel-7.1.0+-2.x86_64.rpm
 Executing(%clean): /bin/sh -e /var/tmp/rpm-tmp.0J6zal
 + umask 022
 + cd /home/opc/linux-uek
 + rm -rf /home/opc/linux-uek/rpmbuild/BUILDROOT/kernel-7.1.0+-2.x86_64
 + RPM_EC=0
 ++ jobs -p
 + exit 0
```
...
```
sudo dnf install -y /home/opc/linux-uek/rpmbuild/RPMS/x86_64/kernel-7.1.0+-2.x86_64.rpm
sudo grubby --set-default /boot/vmlinuz-7.1.0+
 The default is /boot/loader/entries/e3b44b41fd25421f99d3ff3416d9d237-7.1.0+.conf with index 3 and kernel /boot/vmlinuz-7.1.0+
sudo reboot
```
