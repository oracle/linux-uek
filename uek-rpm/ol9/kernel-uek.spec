...
%endif
%endif
%define rpmversion 6.11.%{base_sublevel}%{?stablerev}
...
%define gitrev 0
# Set rpm version accordingly
%define rpmversion 6.11.%{upstream_sublevel}
%endif
...
%define kversion 6.11.%{base_sublevel}
...
%if 0%{?released_kernel}
%define vanillaversion 6.11.%{base_sublevel}
# non-released_kernel case
%else
%if 0%{?rcrev}
%define vanillaversion 6.11.%{upstream_sublevel}-rc%{rcrev}
%if 0%{?gitrev}
%define vanillaversion 6.11.%{upstream_sublevel}-rc%{rcrev}-git%{gitrev}
%endif
%else
# pre-{base_sublevel+1}-rc1 case
%if 0%{?gitrev}
%define vanillaversion 6.11.%{base_sublevel}-git%{gitrev}
%endif
%endif
%endif
...
%endif
    ...
    make %{?make_opts} ARCH=$Arch %{?_kernel_cc} %{?_smp_mflags} INSTALL_MOD_PATH=$RPM_BUILD_ROOT ctf_install KERNELRELEASE=$KernelVer
