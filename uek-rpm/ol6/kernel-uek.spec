...
%endif
%endif
%define rpmversion 3.8.%{base_sublevel}%{?stablerev}
...
%define gitrev 0
# Set rpm version accordingly
%define rpmversion 3.8.%{upstream_sublevel}
%endif
...
%define package_conflicts initscripts < 7.23, udev < 063-6, iptables < 1.3.2-1, ipw2200-firmware < 2.4, selinux-policy-targeted < 1.25.3-14, device-mapper-multipath < 0.4.9-64, dracut < 004-303.0.3, bfa-firmware < 3.2.23.0-2
...
# scripts use them.
#
%define kernel_prereq  fileutils, module-init-tools, initscripts >= 8.11.1-1, kernel-firmware = %{rpmversion}-%{pkg_release}, /sbin/new-kernel-pkg, ql23xx-firmware, ql2400-firmware >= 8.02.00-1.0.1, ql2500-firmware >= 8.02.00-1.0.1, ql2600-firmware >= 8.01.02-1.0.1, ql2700-firmware >= 8.01.02-1.0.1, ql8300-firmware >= 8.01.02-1.0.1
...
patch %{_builddir}/find-debuginfo.sh %{SOURCE301} || \
      { mv -f %{_builddir}/find-debuginfo.sh.orig %{_builddir}/find_debuginfo.sh && \
