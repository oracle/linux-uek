...
%endif
%endif
%define uekrpm_version 6.13.%{base_sublevel}%{?stablerev}
...
%define gitrev 0
# Set rpm version accordingly
%define uekrpm_version 6.13.%{upstream_sublevel}
%endif
...
Conflicts: shim-x64 <= 15.3-1.0.5\
Conflicts: shim-ia32 <= 15.3-1.0.5\
