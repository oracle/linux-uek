...
lpfc_debugfs_initialize(struct lpfc_vport *vport)
{
	...
	scnprintf(name, sizeof(name), "fn%d", phba->brd_no);
	if (!phba->hba_debugfs_root) {
		...
		/* Setup hbqinfo */
		scnprintf(name, sizeof(name), "hbqinfo");
		phba->debug_hbqinfo =
		...
		if (phba->sli_rev < LPFC_SLI_REV4) {
			scnprintf(name, sizeof(name), "dumpHBASlim");
		...
		/* Setup dumpHostSlim */
		if (phba->sli_rev < LPFC_SLI_REV4) {
			scnprintf(name, sizeof(name), "dumpHostSlim");
		...
		/* Setup dumpData */
		scnprintf(name, sizeof(name), "dumpData");
		phba->debug_dumpData =
			debugfs_create_file(name, S_IFREG|S_IRUGO|S_IWUSR,
				 phba->hba_debugfs_root,
		...
		/* Setup dumpDif */
		scnprintf(name, sizeof(name), "dumpDif");
		phba->debug_dumpDif =
			debugfs_create_file(name, S_IFREG|S_IRUGO|S_IWUSR,
				 phba->hba_debugfs_root,
		...
		scnprintf(name, sizeof(name), "InjErrLBA");
		...
		scnprintf(name, sizeof(name), "InjErrNPortID");
		phba->debug_InjErrNPortID =
			debugfs_create_file(name, S_IFREG|S_IRUGO|S_IWUSR,
			phba->hba_debugfs_root,
			phba, &lpfc_debugfs_op_dif_err);

		scnprintf(name, sizeof(name), "InjErrWWPN");
		phba->debug_InjErrWWPN =
			debugfs_create_file(name, S_IFREG|S_IRUGO|S_IWUSR,
			phba->hba_debugfs_root,
			phba, &lpfc_debugfs_op_dif_err);

		scnprintf(name, sizeof(name), "writeGuardInjErr");
		phba->debug_writeGuard =
			debugfs_create_file(name, S_IFREG|S_IRUGO|S_IWUSR,
			phba->hba_debugfs_root,
			phba, &lpfc_debugfs_op_dif_err);

		scnprintf(name, sizeof(name), "writeAppInjErr");
		phba->debug_writeApp =
			debugfs_create_file(name, S_IFREG|S_IRUGO|S_IWUSR,
			phba->hba_debugfs_root,
			phba, &lpfc_debugfs_op_dif_err);

		scnprintf(name, sizeof(name), "writeRefInjErr");
		phba->debug_writeRef =
			debugfs_create_file(name, S_IFREG|S_IRUGO|S_IWUSR,
			phba->hba_debugfs_root,
			phba, &lpfc_debugfs_op_dif_err);

		scnprintf(name, sizeof(name), "readGuardInjErr");
		phba->debug_readGuard =
			debugfs_create_file(name, S_IFREG|S_IRUGO|S_IWUSR,
			phba->hba_debugfs_root,
			phba, &lpfc_debugfs_op_dif_err);

		scnprintf(name, sizeof(name), "readAppInjErr");
		phba->debug_readApp =
			debugfs_create_file(name, S_IFREG|S_IRUGO|S_IWUSR,
			phba->hba_debugfs_root,
			phba, &lpfc_debugfs_op_dif_err);

		scnprintf(name, sizeof(name), "readRefInjErr");
		phba->debug_readRef =
			debugfs_create_file(name, S_IFREG|S_IRUGO|S_IWUSR,
			phba->hba_debugfs_root,
			phba, &lpfc_debugfs_op_dif_err);
		...
		scnprintf(name, sizeof(name), "slow_ring_trace");
		...
		scnprintf(name, sizeof(name), "nvmeio_trc");
...
nvmeio_off:
	...
	scnprintf(name, sizeof(name), "vport%d", vport->vpi);
	...
	scnprintf(name, sizeof(name), "discovery_trace");
	vport->debug_disc_trc =
		debugfs_create_file(name, S_IFREG|S_IRUGO|S_IWUSR,
				 vport->vport_debugfs_root,
				 vport, &lpfc_debugfs_op_disc_trc);
	scnprintf(name, sizeof(name), "nodelist");
	vport->debug_nodelist =
		debugfs_create_file(name, S_IFREG|S_IRUGO|S_IWUSR,
				 vport->vport_debugfs_root,
				 vport, &lpfc_debugfs_op_nodelist);

	scnprintf(name, sizeof(name), "nvmestat");
	vport->debug_nvmestat =
		debugfs_create_file(name, 0644,
				    vport->vport_debugfs_root,
				    vport, &lpfc_debugfs_op_nvmestat);

	scnprintf(name, sizeof(name), "nvmektime");
	vport->debug_nvmektime =
		debugfs_create_file(name, 0644,
				    vport->vport_debugfs_root,
				    vport, &lpfc_debugfs_op_nvmektime);

	scnprintf(name, sizeof(name), "cpucheck");
	...
	scnprintf(name, sizeof(name), "iDiag");
	if (!phba->idiag_root) {
		phba->idiag_root =
			debugfs_create_dir(name, phba->hba_debugfs_root);
	...
	scnprintf(name, sizeof(name), "pciCfg");
	...
	scnprintf(name, sizeof(name), "barAcc");
	...
	scnprintf(name, sizeof(name), "queInfo");
	...
	scnprintf(name, sizeof(name), "queAcc");
	...
	scnprintf(name, sizeof(name), "drbAcc");
	...
	scnprintf(name, sizeof(name), "ctlAcc");
	...
	scnprintf(name, sizeof(name), "mbxAcc");
	...
	if (phba->sli4_hba.extents_in_use) {
		scnprintf(name, sizeof(name), "extAcc");
