...
extern void iscsit_start_login_timer(struct iscsi_conn *, struct task_struct *kthr);
extern void iscsit_stop_login_timer(struct iscsi_conn *);
extern int iscsit_set_login_timer_kworker(struct iscsi_conn *, struct task_struct *kthr);
