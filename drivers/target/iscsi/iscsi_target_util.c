...
void iscsit_start_login_timer(struct iscsi_conn *conn, struct task_struct *kthr)
{
...
int iscsit_set_login_timer_kworker(struct iscsi_conn *conn, struct task_struct *kthr)
{
	struct iscsi_login *login = conn->login;
	int ret = 0;
