...
extern u32  asm_integrity_format(struct block_device *, bool);
extern int  asm_integrity_check(struct oracleasm_integrity_v2 *, struct block_device *, bool);
...
#define asm_integrity_format(a, b)	(0)
#define asm_integrity_check(a, b, c)	(0)
