...
static bool disable_runtime= (IS_ENABLED(CONFIG_EFI_BOOTEFI_BUG));
...
static int __init efi_memreserve_map_root(void)
{
	...
	efi_memreserve_root = ioremap(efi.mem_reserve,
 ...
 *  functions provide an alternative way to populate efi.mem_reserve so that
...
static __init int pensando_efi_get_fdt_params(void)
{
	...
	ret = of_scan_flat_dt(pensando_fdt_find_uefi_params, &info);
