...
static int otx2_bphypf_get_rxfh(struct net_device *dev,
				struct ethtool_rxfh_param *param)
{
	return otx2_bphypf_get_rxfh_context(dev, param->indir, param->key,
					    &param->hfunc,
					    DEFAULT_RSS_CONTEXT_GROUP);
}

/* Configure RSS table and hash key */
static int otx2_bphypf_set_rxfh(struct net_device *dev,
				struct ethtool_rxfh_param *param,
				struct netlink_ext_ack *extack)
{
	u32 rss_context = DEFAULT_RSS_CONTEXT_GROUP;

	return otx2_bphypf_set_rxfh_context(dev, param->indir,
					    param->key, param->hfunc,
					    &rss_context, 0);
}
