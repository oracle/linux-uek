...
#define MIO_PTP_PPS_THRESH_LO		0x50ULL
#define MIO_PTP_PPS_THRESH_HI		0x58ULL
#define MIO_PTP_CLOCK_COMP		0x18ULL
#define MIO_PTP_CLOCK_SEC		0xD0ULL
#define PTP_CLOCK_CFG_PPS_EN            BIT(30)
#define PTP_CLOCK_CFG_PPS_INV           BIT(31)
#define MIO_PTP_PPS_HI_INCR		0xF60ULL
#define MIO_PTP_PPS_LO_INCR		0xF68ULL
