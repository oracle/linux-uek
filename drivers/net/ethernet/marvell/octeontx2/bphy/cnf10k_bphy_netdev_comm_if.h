...
enum bphy_netdev_cpri_rx_gp_int {
	CNF10K_RX_GP_INT_CPRI0_ETH = 45, //PSM_GPINT45,
	CNF10K_RX_GP_INT_CPRI1_ETH = 46, //PSM_GPINT46,
	CNF10K_RX_GP_INT_CPRI2_ETH = 47, //PSM_GPINT47
};
...
enum bphy_netdev_rx_gp_int {
	CNF10K_RX_GP_INT_RFOE0_PTP       = 66, //PSM_GPINT66,
	CNF10K_RX_GP_INT_RFOE0_ECPRI     = 65, //PSM_GPINT65,
	CNF10K_RX_GP_INT_RFOE0_GENERIC   = 64, //PSM_GPINT64,

	CNF10K_RX_GP_INT_RFOE1_PTP       = 63, //PSM_GPINT63,
	CNF10K_RX_GP_INT_RFOE1_ECPRI     = 62, //PSM_GPINT62,
	CNF10K_RX_GP_INT_RFOE1_GENERIC   = 61, //PSM_GPINT61,
#ifdef CNF10KB
	CNF10K_RX_GP_INT_RFOE2_PTP       = 60, //PSM_GPINT60,
	CNF10K_RX_GP_INT_RFOE2_ECPRI     = 59, //PSM_GPINT59,
	CNF10K_RX_GP_INT_RFOE2_GENERIC   = 58, //PSM_GPINT58,

	CNF10K_RX_GP_INT_RFOE3_PTP       = 57, //PSM_GPINT57,
	CNF10K_RX_GP_INT_RFOE3_ECPRI     = 56, //PSM_GPINT56,
	CNF10K_RX_GP_INT_RFOE3_GENERIC   = 55, //PSM_GPINT55,

	CNF10K_RX_GP_INT_RFOE4_PTP       = 54, //PSM_GPINT54,
	CNF10K_RX_GP_INT_RFOE4_ECPRI     = 53, //PSM_GPINT53,
	CNF10K_RX_GP_INT_RFOE4_GENERIC   = 52, //PSM_GPINT52,

	CNF10K_RX_GP_INT_RFOE5_PTP       = 51, //PSM_GPINT51,
	CNF10K_RX_GP_INT_RFOE5_ECPRI     = 50, //PSM_GPINT50,
	CNF10K_RX_GP_INT_RFOE5_GENERIC   = 49, //PSM_GPINT49,

	CNF10K_RX_GP_INT_RFOE6_PTP       = 48, //PSM_GPINT48,
	CNF10K_RX_GP_INT_RFOE6_ECPRI     = 47, //PSM_GPINT47,
	CNF10K_RX_GP_INT_RFOE6_GENERIC   = 46, //PSM_GPINT46,
#endif
};
