...
static const struct devlink_ops mlxsw_devlink_ops = {
	.reload_actions		= BIT(DEVLINK_RELOAD_ACTION_DRIVER_REINIT) |
				  BIT(DEVLINK_RELOAD_ACTION_FW_ACTIVATE),
	.reload_down_new		= mlxsw_devlink_core_bus_device_reload_down,
	.reload_up_new			= mlxsw_devlink_core_bus_device_reload_up,
	...
	.trap_action_set_new		= mlxsw_devlink_trap_action_set,
