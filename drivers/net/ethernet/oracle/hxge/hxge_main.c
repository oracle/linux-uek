...
static const char hxge_driver_string[] = "Oracle Corporation(R) 10 Gigabit  Network Driver";
...
static const char hxge_copyright[] = "Copyright (c) 2009, 2013 Oracle America.";
