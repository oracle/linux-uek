...
#define TSTORM_TCP_MAX_CWND_OFFSET(pfId) \
	(IRO[219].base + ((pfId) * IRO[219].m1))
#define TSTORM_VF_TO_PF_OFFSET(funcId) \
	(IRO[104].base + ((funcId) * IRO[104].m1))
#define USTORM_AGG_DATA_OFFSET (IRO[208].base)
#define USTORM_AGG_DATA_SIZE (IRO[208].size)
...
#define USTORM_RX_PRODS_E1X_OFFSET(portId, clientId) \
	(IRO[211].base + ((portId) * IRO[211].m1) + ((clientId) * \
	IRO[211].m2))
#define USTORM_RX_PRODS_E2_OFFSET(qzoneId) \
	(IRO[212].base + ((qzoneId) * IRO[212].m1))
#define USTORM_TPA_BTR_OFFSET (IRO[209].base)
#define USTORM_TPA_BTR_SIZE (IRO[209].size)
...
#define XSTORM_TCP_GLOBAL_DEL_ACK_COUNTER_ENABLED_OFFSET(portId) \
	(IRO[213].base + ((portId) * IRO[213].m1))
#define XSTORM_TCP_GLOBAL_DEL_ACK_COUNTER_MAX_COUNT_OFFSET(portId) \
	(IRO[214].base + ((portId) * IRO[214].m1))
#define XSTORM_TCP_TX_SWS_TIMER_VAL_OFFSET(pfId) \
	(IRO[216].base + (((pfId)>>1) * IRO[216].m1) + (((pfId)&1) * \
	IRO[216].m2))
...
/* eth hsi version */
#define ETH_FP_HSI_VERSION (ETH_FP_HSI_VER_1)
