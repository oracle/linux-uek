...
#define u64_stats_update_begin do { } while(0)
#define u64_stats_update_end do { } while(0)
#define u64_stats_fetch_begin do { } while(0)
#define u64_stats_fetch_retry_bh (0)
