 ...
 *
 * This file provides LBHDR access functions for BCM56996_B0.
 *
 ******************************************************************************/
...
const bcmpkt_lbhdr_fget_t bcm56996_b0_lbhdr_fget = {
    {
...
const bcmpkt_lbhdr_fset_t bcm56996_b0_lbhdr_fset = {
    {
...
const bcmpkt_lbhdr_figet_t bcm56996_b0_lbhdr_figet = {
    {
        bcmpkt_lbhdr_i_size_get
    }
};

static shr_enum_map_t bcm56996_b0_lbhdr_view_types[] = {
    {"trill_nw", 1},
    {"trill_ac", 2},
    {"ethernet", 3},
    {NULL, -1},
...
static int bcm56996_b0_lbhdr_view_infos[BCMPKT_LBHDR_FID_COUNT] = {
...
void bcm56996_b0_lbhdr_view_info_get(bcmpkt_pmd_view_info_t *info)
{
    info->view_infos = bcm56996_b0_lbhdr_view_infos;
    info->view_types = bcm56996_b0_lbhdr_view_types;
