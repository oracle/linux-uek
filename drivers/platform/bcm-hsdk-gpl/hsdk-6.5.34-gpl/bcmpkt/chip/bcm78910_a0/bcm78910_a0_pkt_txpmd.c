 ...
 *
 * This file provides TXPMD access functions for BCM78910_A0.
 *
 ******************************************************************************/
...
static void bcmpkt_txpmd_cos_set(uint32_t *data, uint32_t val)
{
    ...
    WORD_FIELD_SET(data[3], 12, 6, val);
}
...
static uint32_t bcmpkt_txpmd_cos_get(uint32_t *data)
{
    ...
    val = WORD_FIELD_GET(data[3], 12, 6);
    return val;
}
...
static void bcmpkt_txpmd_cng_set(uint32_t *data, uint32_t val)
{
    ...
    WORD_FIELD_SET(data[3], 10, 2, val);
}
...
static uint32_t bcmpkt_txpmd_cng_get(uint32_t *data)
{
    ...
    val = WORD_FIELD_GET(data[3], 10, 2);
    return val;
}
...
static void bcmpkt_txpmd_destination_set(uint32_t *data, uint32_t val)
{
    ...
    WORD_FIELD_SET(data[3], 18, 14, val & MASK(14));
    WORD_FIELD_SET(data[2], 0, 2, (val >> 14) & MASK(2));
}
...
static uint32_t bcmpkt_txpmd_destination_get(uint32_t *data)
{
    ...
    val = (WORD_FIELD_GET(data[3], 18, 14) | (WORD_FIELD_GET(data[2], 0, 2) << 14)) ;
    return val;
}
...
static void bcmpkt_txpmd_cpu_tx_destination_set(uint32_t *data, uint32_t val)
{
    ...
    WORD_FIELD_SET(data[3], 27, 5, val & MASK(5));
    WORD_FIELD_SET(data[2], 0, 11, (val >> 5) & MASK(11));
}
...
static uint32_t bcmpkt_txpmd_cpu_tx_destination_get(uint32_t *data)
{
    ...
    val = (WORD_FIELD_GET(data[3], 27, 5) | (WORD_FIELD_GET(data[2], 0, 11) << 5)) ;
    return val;
}
...
static void bcmpkt_txpmd_cpu_tx_destination_type_set(uint32_t *data, uint32_t val)
{
    ...
    WORD_FIELD_SET(data[2], 11, 4, val);
}
...
static uint32_t bcmpkt_txpmd_cpu_tx_destination_type_get(uint32_t *data)
{
    ...
    val = WORD_FIELD_GET(data[2], 11, 4);
    return val;
}
...
static void bcmpkt_txpmd_cpu_tx_input_pri_set(uint32_t *data, uint32_t val)
{
    ...
    WORD_FIELD_SET(data[2], 17, 4, val);
}
...
static uint32_t bcmpkt_txpmd_cpu_tx_input_pri_get(uint32_t *data)
{
    ...
    val = WORD_FIELD_GET(data[2], 17, 4);
    return val;
}
...
static void bcmpkt_txpmd_cpu_tx_int_cn_set(uint32_t *data, uint32_t val)
{
    ...
    WORD_FIELD_SET(data[2], 21, 2, val);
}
...
static uint32_t bcmpkt_txpmd_cpu_tx_int_cn_get(uint32_t *data)
{
    ...
    val = WORD_FIELD_GET(data[2], 21, 2);
    return val;
}
...
static void bcmpkt_txpmd_cpu_tx_int_pri_set(uint32_t *data, uint32_t val)
{
    ...
    WORD_FIELD_SET(data[2], 23, 4, val);
}
...
static uint32_t bcmpkt_txpmd_cpu_tx_int_pri_get(uint32_t *data)
{
    ...
    val = WORD_FIELD_GET(data[2], 23, 4);
    return val;
}
...
static void bcmpkt_txpmd_cpu_tx_mcast_lb_index_vld_set(uint32_t *data, uint32_t val)
{
    ...
    WORD_FIELD_SET(data[2], 27, 1, val);
}
...
static uint32_t bcmpkt_txpmd_cpu_tx_mcast_lb_index_vld_get(uint32_t *data)
{
    ...
    val = WORD_FIELD_GET(data[2], 27, 1);
    return val;
}
...
static void bcmpkt_txpmd_cpu_tx_pkt_profile_set(uint32_t *data, uint32_t val)
{
    ...
    WORD_FIELD_SET(data[2], 28, 3, val);
}
...
static uint32_t bcmpkt_txpmd_cpu_tx_pkt_profile_get(uint32_t *data)
{
    ...
    val = WORD_FIELD_GET(data[2], 28, 3);
    return val;
}
...
static void bcmpkt_txpmd_cpu_tx_vrf_set(uint32_t *data, uint32_t val)
{
    ...
    WORD_FIELD_SET(data[1], 14, 13, val);
}
...
static uint32_t bcmpkt_txpmd_cpu_tx_vrf_get(uint32_t *data)
{
    ...
    val = WORD_FIELD_GET(data[1], 14, 13);
    return val;
}
...
static void bcmpkt_txpmd_cpu_tx_vrf_valid_set(uint32_t *data, uint32_t val)
{
    ...
    WORD_FIELD_SET(data[1], 27, 1, val);
}
...
static uint32_t bcmpkt_txpmd_cpu_tx_vrf_valid_get(uint32_t *data)
{
    ...
    val = WORD_FIELD_GET(data[1], 27, 1);
    return val;
}
...
static void bcmpkt_txpmd_cpu_tx_cookie_set(uint32_t *data, uint32_t val)
{
    ...
    WORD_FIELD_SET(data[3], 17, 9, val);
}
...
static uint32_t bcmpkt_txpmd_cpu_tx_cookie_get(uint32_t *data)
{
    ...
    val = WORD_FIELD_GET(data[3], 17, 9);
    return val;
}

static void bcmpkt_txpmd_cpu_tx_cookie_valid_set(uint32_t *data, uint32_t val)
{
    if (bcmpkt_txpmd_header_type_get(data) != BCMPKT_TXPMD_HEADER_T_CPU_TX) {
        return;
    }
...
static uint32_t bcmpkt_txpmd_cpu_tx_cookie_valid_get(uint32_t *data)
{
    uint32_t val;
    if (bcmpkt_txpmd_header_type_get(data) != BCMPKT_TXPMD_HEADER_T_CPU_TX) {
        return 0;
...
static void bcmpkt_txpmd_cpu_tx_svp_set(uint32_t *data, uint32_t val)
{
    if (bcmpkt_txpmd_header_type_get(data) != BCMPKT_TXPMD_HEADER_T_CPU_TX) {
        return;
    }
    WORD_FIELD_SET(data[1], 1, 13, val);
}

static uint32_t bcmpkt_txpmd_cpu_tx_svp_get(uint32_t *data)
{
    uint32_t val;
    if (bcmpkt_txpmd_header_type_get(data) != BCMPKT_TXPMD_HEADER_T_CPU_TX) {
        return 0;
    }
    val = WORD_FIELD_GET(data[1], 1, 13);
    return val;
}
...
const bcmpkt_txpmd_fget_t bcm78910_a0_txpmd_fget = {
    {
        ...
        bcmpkt_txpmd_cpu_tx_cookie_valid_get,
...
const bcmpkt_txpmd_fset_t bcm78910_a0_txpmd_fset = {
    {
        ...
        bcmpkt_txpmd_cpu_tx_cookie_valid_set,
...
const bcmpkt_txpmd_figet_t bcm78910_a0_txpmd_figet = {
    {
        bcmpkt_txpmd_i_size_get
    }
};

static shr_enum_map_t bcm78910_a0_txpmd_view_types[] = {
    {"sobmh_from_cpu", 1},
    {"cpu_tx", 2},
    {NULL, -1},
};
...
static int bcm78910_a0_txpmd_view_infos[BCMPKT_TXPMD_FID_COUNT] = {
...
void bcm78910_a0_txpmd_view_info_get(bcmpkt_pmd_view_info_t *info)
{
    info->view_infos = bcm78910_a0_txpmd_view_infos;
    info->view_types = bcm78910_a0_txpmd_view_types;
