 ...
 *
 * This file provides RXPMD access functions for BCM78914_B0.
 *
 ******************************************************************************/
...
{
    WORD_FIELD_SET(data[11], 26, 6, val);
}

static uint32_t bcmpkt_rxpmd_queue_num_get(uint32_t *data)
{
    uint32_t val;
    val = WORD_FIELD_GET(data[11], 26, 6);
    return val;
}
...
{
    WORD_FIELD_SET(data[8], 6, 6, val);
}

static uint32_t bcmpkt_rxpmd_dscp_get(uint32_t *data)
{
    uint32_t val;
    val = WORD_FIELD_GET(data[8], 6, 6);
    return val;
}
...
static void bcmpkt_rxpmd_matched_rule_ep_set(uint32_t *data, uint32_t val)
{
    WORD_FIELD_SET(data[8], 16, 9, val);
}

static uint32_t bcmpkt_rxpmd_matched_rule_ep_get(uint32_t *data)
{
    uint32_t val;
    val = WORD_FIELD_GET(data[8], 16, 9);
    return val;
}

static void bcmpkt_rxpmd_is_egr_ts_set(uint32_t *data, uint32_t val)
{
    WORD_FIELD_SET(data[8], 25, 1, val);
}

static uint32_t bcmpkt_rxpmd_is_egr_ts_get(uint32_t *data)
{
    uint32_t val;
    val = WORD_FIELD_GET(data[8], 25, 1);
    return val;
}

static void bcmpkt_rxpmd_modified_pkt_set(uint32_t *data, uint32_t val)
{
    WORD_FIELD_SET(data[7], 30, 1, val);
}

static uint32_t bcmpkt_rxpmd_modified_pkt_get(uint32_t *data)
{
    uint32_t val;
    val = WORD_FIELD_GET(data[7], 30, 1);
    return val;
}
 ...
 * SIZE:     51
 ******************************************************************************/
void bcm78914_b0_rx_reason_encode(const bcmpkt_rx_reasons_t *reasons, uint32_t *data)
{
    ...
    if (BCMPKT_RX_REASON_GET(*reasons, BCMPKT_RX_REASON_APU_POLICY_CTC)) {
        data[0] |= (0x1 << 14);
    }
    if (BCMPKT_RX_REASON_GET(*reasons, BCMPKT_RX_REASON_DELAYED_CTC)) {
        data[0] |= (0x1 << 15);
    }
    if (BCMPKT_RX_REASON_GET(*reasons, BCMPKT_RX_REASON_PORT_DOWN)) {
        data[0] |= (0x1 << 16);
    }
    if (BCMPKT_RX_REASON_GET(*reasons, BCMPKT_RX_REASON_SRV6_CONTROL_PKT)) {
        data[0] |= (0x1 << 17);
    }
    if (BCMPKT_RX_REASON_GET(*reasons, BCMPKT_RX_REASON_OUI_COMPRESSION_MISS)) {
        data[0] |= (0x1 << 18);
    }
}

void bcm78914_b0_rx_reason_decode(const uint32_t *data, bcmpkt_rx_reasons_t *reasons)
{
    uint32_t val;
    ...
    if (data[0] & (0x1 << 14)) {
        BCMPKT_RX_REASON_SET(*reasons, BCMPKT_RX_REASON_APU_POLICY_CTC);
    }
    if (data[0] & (0x1 << 15)) {
        BCMPKT_RX_REASON_SET(*reasons, BCMPKT_RX_REASON_DELAYED_CTC);
    }
    if (data[0] & (0x1 << 16)) {
        BCMPKT_RX_REASON_SET(*reasons, BCMPKT_RX_REASON_PORT_DOWN);
    }
    if (data[0] & (0x1 << 17)) {
        BCMPKT_RX_REASON_SET(*reasons, BCMPKT_RX_REASON_SRV6_CONTROL_PKT);
    }
    if (data[0] & (0x1 << 18)) {
        BCMPKT_RX_REASON_SET(*reasons, BCMPKT_RX_REASON_OUI_COMPRESSION_MISS);
    }
}
 ...
 * SIZE:     64
 ******************************************************************************/
void bcm78914_b0_ep_rx_reason_encode(const bcmpkt_rx_reasons_t *reasons, uint32_t *data)
{
...
void bcm78914_b0_ep_rx_reason_decode(const uint32_t *data, bcmpkt_rx_reasons_t *reasons)
{
    uint32_t val;
    COMPILER_REFERENCE(val);
    if (data[1] & (0x1 << 0)) {
...
const bcmpkt_rxpmd_fget_t bcm78914_b0_rxpmd_fget = {
    {
        ...
        NULL,
        NULL,
        bcmpkt_rxpmd_matched_rule_ep_get,
        bcmpkt_rxpmd_is_egr_ts_get,
        bcmpkt_rxpmd_modified_pkt_get,
        NULL,
        NULL
    }
};
...
const bcmpkt_rxpmd_fset_t bcm78914_b0_rxpmd_fset = {
    {
        ...
        NULL,
        NULL,
        bcmpkt_rxpmd_matched_rule_ep_set,
        bcmpkt_rxpmd_is_egr_ts_set,
        bcmpkt_rxpmd_modified_pkt_set,
        NULL,
        NULL
    }
};
...
const bcmpkt_rxpmd_figet_t bcm78914_b0_rxpmd_figet = {
    {
...
static shr_enum_map_t bcm78914_b0_rxpmd_view_types[] = {
    {NULL, -1},
};

/* -2: unsupported, -1: global, others: view's value */
static int bcm78914_b0_rxpmd_view_infos[BCMPKT_RXPMD_FID_COUNT] = {
     ...
     -2, -1, -2, -2, -1, -2, -2, -2, -2, -1, -2, -2, -2, -2, -2, -2,
     -1, -1, -1, -2, -2,
};


void bcm78914_b0_rxpmd_view_info_get(bcmpkt_pmd_view_info_t *info)
{
    info->view_infos = bcm78914_b0_rxpmd_view_infos;
    info->view_types = bcm78914_b0_rxpmd_view_types;
