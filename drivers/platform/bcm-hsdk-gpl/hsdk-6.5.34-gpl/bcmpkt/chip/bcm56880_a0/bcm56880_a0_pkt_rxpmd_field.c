/*! \file bcm56880_a0_pkt_rxpmd_field.c
 *
...
int bcm56880_a0_rxpmd_flex_fget(uint32_t *data,
                                bcmpkt_flex_field_metadata_t *fld_info,
                                int prof,
                                uint32_t *val)
{
    uint32_t hdr_words = 13; /* MPB_FLEX_DATA size in words. */
...
int bcm56880_a0_rxpmd_flex_fset(uint32_t *data,
                                bcmpkt_flex_field_metadata_t *fld_info,
                                int prof,
                                uint32_t val)
{
