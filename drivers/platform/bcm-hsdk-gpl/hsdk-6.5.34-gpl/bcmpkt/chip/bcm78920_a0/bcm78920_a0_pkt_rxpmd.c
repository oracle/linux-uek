 ...
 *
 * This file provides RXPMD access functions for BCM78920_A0.
 *
 ******************************************************************************/
...
static void bcmpkt_rxpmd_rx_chip_port_set(uint32_t *data, uint32_t val)
{
    WORD_FIELD_SET(data[3], 23, 9, val);
}

static uint32_t bcmpkt_rxpmd_rx_chip_port_get(uint32_t *data)
{
    uint32_t val;
...
static void bcmpkt_rxpmd_rx_vpp_port_set(uint32_t *data, uint32_t val)
{
    WORD_FIELD_SET(data[3], 12, 3, val);
}

static uint32_t bcmpkt_rxpmd_rx_vpp_port_get(uint32_t *data)
{
    uint32_t val;
...
static void bcmpkt_rxpmd_nonsw_copy_set(uint32_t *data, uint32_t val)
{
    WORD_FIELD_SET(data[0], 15, 1, val);
}

static uint32_t bcmpkt_rxpmd_nonsw_copy_get(uint32_t *data)
{
    uint32_t val;
...
void bcm78920_a0_rx_reason_encode(const bcmpkt_rx_reasons_t *reasons, uint32_t *data)
{
}

void bcm78920_a0_rx_reason_decode(const uint32_t *data, bcmpkt_rx_reasons_t *reasons)
{
}

void bcm78920_a0_ep_rx_reason_encode(const bcmpkt_rx_reasons_t *reasons, uint32_t *data)
{
}

void bcm78920_a0_ep_rx_reason_decode(const uint32_t *data, bcmpkt_rx_reasons_t *reasons)
{
}

const bcmpkt_rxpmd_fget_t bcm78920_a0_rxpmd_fget = {
    {
        NULL,
        ...
        NULL,
        NULL,
        bcmpkt_rxpmd_rx_chip_port_get,
        NULL,
        NULL,
        bcmpkt_rxpmd_rx_vpp_port_get,
        bcmpkt_rxpmd_nonsw_copy_get,
        NULL,
        NULL,
        NULL,
        NULL,
...
const bcmpkt_rxpmd_fset_t bcm78920_a0_rxpmd_fset = {
    {
        NULL,
        ...
        NULL,
        NULL,
        bcmpkt_rxpmd_rx_chip_port_set,
        NULL,
        NULL,
        bcmpkt_rxpmd_rx_vpp_port_set,
        bcmpkt_rxpmd_nonsw_copy_set,
        NULL,
        NULL,
        NULL,
        NULL,
...
const bcmpkt_rxpmd_figet_t bcm78920_a0_rxpmd_figet = {
    {
...
static shr_enum_map_t bcm78920_a0_rxpmd_view_types[] = {
    {NULL, -1},
};

/* -2: unsupported, -1: global, others: view's value */
static int bcm78920_a0_rxpmd_view_infos[BCMPKT_RXPMD_FID_COUNT] = {
     -2, -1, -2, -2, -2, -1, -2, -2, -2, -2, -2, -2, -2, -2, -2, -2,
     -2, -2, -2, -2, -2, -2, -2, -2, -2, -1, -1, -2, -2, -2, -1, -2,
     -2, -2, -2, -2, -2, -2, -2, -2, -2, -2, -2, -2, -2, -2, -2, -2,
     -2, -2, -2, -2, -2, -2, -2, -2, -2, -2, -2, -2, -2, -2, -2, -2,
     -2, -1, -2, -2, -1, -1, -1, -1, -1, -1, -1, -1, -2, -1, -1, -2,
     -2, -2, -2, -2, -2, -2, -2, -1, -1, -2, -2, -1, -2, -2, -1, -1,
     -2, -2, -2, -2, -2,
};


void bcm78920_a0_rxpmd_view_info_get(bcmpkt_pmd_view_info_t *info)
{
    info->view_infos = bcm78920_a0_rxpmd_view_infos;
    info->view_types = bcm78920_a0_rxpmd_view_types;
