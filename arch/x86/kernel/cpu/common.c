...
static const struct x86_cpu_id cpu_vuln_blacklist[] = {
	...
	VULNBL_INTEL_STEPPINGS(ALDERLAKE,	X86_STEPPING_ANY,		VMSCAPE),
	VULNBL_INTEL_STEPPINGS(ALDERLAKE_L,	X86_STEPPING_ANY,		VMSCAPE),
	VULNBL_INTEL_STEPPINGS(RAPTORLAKE,	X86_STEPPING_ANY,		VMSCAPE),
	VULNBL_INTEL_STEPPINGS(RAPTORLAKE_P,	X86_STEPPING_ANY,		VMSCAPE),
	VULNBL_INTEL_STEPPINGS(RAPTORLAKE_S,	X86_STEPPING_ANY,		VMSCAPE),
...
void cpu_clear_bug_bits(struct cpuinfo_x86 *c)
{
	...
	clear_cpu_cap(c, X86_BUG_MMIO_STALE_DATA);
	...
	if (c->cpu_index == boot_cpu_data.cpu_index) {
		...
		setup_clear_cpu_cap(X86_BUG_MMIO_STALE_DATA);
	}
}
