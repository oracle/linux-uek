...
static const __cpuinitconst struct x86_cpu_id cpu_vuln_whitelist[] = {
	...
	VULNWL_INTEL(ATOM_SILVERMONT1,		NO_SSB | NO_L1TF | NO_SWAPGS),
	VULNWL_INTEL(ATOM_SILVERMONT2,		NO_SSB | NO_L1TF | NO_SWAPGS),
	VULNWL_INTEL(ATOM_MERRIFIELD1,		NO_SSB | NO_L1TF | NO_SWAPGS),
	VULNWL_INTEL(ATOM_AIRMONT,		NO_SSB | NO_L1TF | NO_SWAPGS),
	...
	VULNWL_INTEL(ATOM_DENVERTON,		NO_MDS | NO_L1TF | NO_SWAPGS),
	VULNWL_INTEL(ATOM_GEMINI_LAKE,		NO_MDS | NO_L1TF | NO_SWAPGS),
...
static void __cpuinit cpu_set_bug_bits(struct cpuinfo_x86 *c)
{
	...
	if (!cpu_has_eager_fpu) {
		pr_warn_once("eager_fpu is disabled. You are now susceptible "
			     "to CVE-2018-3665.\n");
	}
