...
/* sysfs definitions required for sparc m7 'Kernel PMU events' */
#define SPARC_M7_EVENT_ATTR(name, config)			\
	PMU_EVENT_ATTR_STRING(name, sparc_m7_event_attr_##name,	\
				"event=" #config "0000")

#define SPARC_M7_EVENT_PTR(name) (&sparc_m7_event_attr_##name.attr.attr)

PMU_FORMAT_ATTR(event, "config:0-63");

static struct attribute *sparc_m7_pmu_format_attrs[] = {
	&format_attr_event.attr,
	NULL,
};

static struct attribute_group sparc_m7_pmu_format_attr_group = {
	.name = "format",
	.attrs = sparc_m7_pmu_format_attrs,
};

#include "sparc_m7_pmu_events.h"

static struct attribute_group sparc_m7_pmu_events_attr_group = {
	.name = "events",
	.attrs = sparc_m7_pmu_event_attrs,
};

static const struct attribute_group *sparc_m7_pmu_attr_groups[] = {
	&sparc_m7_pmu_events_attr_group,
	&sparc_m7_pmu_format_attr_group,
	NULL,
};

static const struct sparc_pmu sparc_m7_pmu = {
	.attr_groups	= sparc_m7_pmu_attr_groups,
...
static int __init init_hw_perf_events(void)
{
	...
	pmu.attr_groups = sparc_pmu->attr_groups;
