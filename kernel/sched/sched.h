...
struct cfs_rq {
	...
	u64			throttled_clock;
	UEK_KABI_REPLACE(u64 throttled_clock_task, u64 throttled_clock_pelt)
	UEK_KABI_REPLACE(u64 throttled_clock_task_time, u64 throttled_clock_pelt_time)	
	int			throttled;
	int			throttle_count;
...
static inline bool sched_cpu_cookie_match(struct rq *rq, struct task_struct *p)
{
	...
	return rq->rke->core->rke->core_cookie == p->core_cookie;
}
