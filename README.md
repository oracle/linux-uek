...
|--------------------|-----------------------------|----------------------|-----------------|--------------------------------------------|
| [`uek7/ga`](https://github.com/oracle/linux-uek/tree/uek7/ga)<br/>[`v5.15.0-1.43.1`](https://github.com/oracle/linux-uek/tree/v5.15.0-1.43.1) | v5.15 | Production | `x86_64`, `aarch64` | Oracle Linux 8, Oracle Linux 9 |
