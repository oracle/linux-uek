...
|--------------------|-----------------------------|----------------------|-----------------|--------------------------------------------|
| [`uek5/master`](https://github.com/oracle/linux-uek/tree/uek5/master)<br/>[`v4.14.35-1851.0.20181227_0000`](https://github.com/oracle/linux-uek/tree/v4.14.35-1851.0.20181227_0000) | v4.14 | Development | `x86_64`, `aarch64` | Oracle Linux 7 |
...
| [`uek3/master`](https://github.com/oracle/linux-uek/tree/uek3/master)<br/>[`v3.8.13-118.28.1`](https://github.com/oracle/linux-uek/tree/v3.8.13-118.28.1) | v3.8 | Production | `x86_64` | Oracle Linux 6, Oracle Linux 7 |
| [`uek2/master`](https://github.com/oracle/linux-uek/tree/uek2/master)<br/>[`v2.6.39-400.304.1`](https://github.com/oracle/linux-uek/tree/v2.6.39-400.304.1) | v3.0 | Production | `x86_64`, `SPARC` | Oracle Linux 5, Oracle Linux 6 |
