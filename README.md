...
next generation of the UEK kernel based upon the upstream Linux `v7.1` tag.
...
- LTP read_all_dev fails by timeout which also fails on the
  mainline kernel.

- LTP:thp04 testcase fails which also fails on the mainline kernel.
