...
|--------------------|-----------------------------|----------------------|-----------------|--------------------------------------------|
| [`uek5/master`](https://github.com/oracle/linux-uek/tree/uek5/master)<br/>[`v4.14.35-1821`](https://github.com/oracle/linux-uek/tree/v4.14.35-1821) | v4.14 | Development | `x86_64`, `aarch64` | Oracle Linux 7 |
