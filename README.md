...
|--------------------|-----------------------------|----------------------|-----------------|--------------------------------------------|
| [`uek6/master`](https://github.com/oracle/linux-uek/tree/uek6/master)<br/>[`v5.4.17-2113`](https://github.com/oracle/linux-uek/tree/v5.4.17-2113) | v5.4 | Production | `x86_64`, `aarch64` | Oracle Linux 7, Oracle Linux 8 |
...
| [`uek5/master`](https://github.com/oracle/linux-uek/tree/uek5/master)<br/>[`v4.14.35-2112`](https://github.com/oracle/linux-uek/tree/v4.14.35-2112) | v4.14 | Production | `x86_64`, `aarch64` | Oracle Linux 7 |
