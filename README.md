...
|--------------------|-----------------------------|----------------------|-----------------|--------------------------------------------|
| [`uek7/u2`](https://github.com/oracle/linux-uek/tree/uek7/u2)<br/>[`v5.15.0-204.147.4`](https://github.com/oracle/linux-uek/tree/v5.15.0-204.147.4) | v5.15 | Production | `x86_64`, `aarch64` | Oracle Linux 8, Oracle Linux 9 |
...
| [`uek4/qu7`](https://github.com/oracle/linux-uek/tree/uek4/qu7)<br/>[`v4.1.12-124.83.1`](https://github.com/oracle/linux-uek/tree/v4.1.12-124.83.1) | v4.1 | Production | `x86_64`, `SPARC` | Oracle Linux 6, Oracle Linux 7 |
