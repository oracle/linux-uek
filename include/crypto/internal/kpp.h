 ...
 */
DECLARE_CRYPTO_API(crypto_register_kpp, int, (struct kpp_alg *alg), (alg));
 ...
 * @alg:	algorithm definition
 */
DECLARE_CRYPTO_API(crypto_unregister_kpp, void, (struct kpp_alg *alg), (alg));
 ...
 */
DECLARE_CRYPTO_API(kpp_register_instance, int, (struct crypto_template *tmpl,
			  struct kpp_instance *inst), (tmpl, inst));
 ...
 */
DECLARE_CRYPTO_API(crypto_grab_kpp, int, (struct crypto_kpp_spawn *spawn,
