...
struct xfrmdev_ops {
	...
	UEK_KABI_USE(1, int	(*xdo_dev_policy_add) (struct xfrm_policy *x, struct netlink_ext_ack *extack))
	...
	UEK_KABI_USE(4, void	(*xdo_dev_state_update_stats) (struct xfrm_state *x))
	UEK_KABI_USE(5, int	(*xdo_dev_state_add_new) (struct xfrm_state *x, struct netlink_ext_ack *extack))
	UEK_KABI_RESERVE(6)
	UEK_KABI_RESERVE(7)
};
#endif
...
#define NETDEV_FCOE_WWPN 1
	...
	UEK_KABI_USE(1, int (*ndo_fdb_del_bulk)(struct ndmsg *ndm,
						struct nlattr *tb[],
						struct net_device *dev,
						u16 vid,
						struct netlink_ext_ack *extack))
...
struct net_device {
	...
	bool			uc_promisc;
	UEK_KABI_FILL_HOLE(u16 tso_max_segs)
	UEK_KABI_FILL_HOLE(unsigned int tso_max_size)
	UEK_KABI_FILL_HOLE(struct ref_tracker_dir refcnt_tracker)
#ifdef CONFIG_LOCKDEP
...
#define GRO_MAX_SIZE		(8 * 65535u)
	UEK_KABI_FILL_HOLE(unsigned int		gro_max_size)
 ...
 */
	...
	UEK_KABI_FILL_HOLE(xdp_features_t xdp_features)
