 ...
 */
#ifdef ARCH_FTRACE_REGS_GENKSYMS_DEF
/*
 * Preserve the historical module ABI view for genksyms while keeping
 * the runtime type opaque for normal compilation.
 */
ARCH_FTRACE_REGS_GENKSYMS_DEF
#undef ARCH_FTRACE_REGS_GENKSYMS_DEF
#else
struct ftrace_regs {
