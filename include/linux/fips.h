...
extern const u8 __initdata _binary_fips140_ko_start[];
extern const u8 __initdata _binary_fips140_ko_end[];
extern const u8 __initdata _binary_fips140_hmac_start[SHA256_DIGEST_SIZE];
