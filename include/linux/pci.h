...
struct pci_dev {
	...
	UEK_KABI_FILL_HOLE(unsigned int	rom_bar_overlap:1)	/* ROM BAR disable broken */
	UEK_KABI_FILL_HOLE(unsigned int	is_msi_managed:1)	/* MSI release via devres installed */
	...
	UEK_KABI_USE(1, void __iomem *msix_base)
	UEK_KABI_RESERVE(2)
	UEK_KABI_RESERVE(3)
	UEK_KABI_RESERVE(4)
	UEK_KABI_RESERVE(5)
...
struct pci_bus {
	...
	UEK_KABI_FILL_HOLE(unsigned int unsafe_warn:1) /* warned about RW1C config write */
