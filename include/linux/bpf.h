...
struct bpf_map_ops {
	...
	UEK_KABI_EXTEND(__poll_t (*map_poll)(struct bpf_map *map, struct file *filp,
...
struct bpf_map {
	...
	UEK_KABI_REPLACE_UNSAFE(atomic_t refcnt ____cacheline_aligned,
...
struct bpf_prog_aux {
	UEK_KABI_REPLACE_UNSAFE(atomic_t refcnt, atomic64_t refcnt)
	u32 used_map_cnt;
	u32 max_ctx_offset;
	u32 max_pkt_offset;
	u32 max_tp_access;
